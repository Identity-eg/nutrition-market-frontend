...
import { icons } from '@/app/ui/icons/list';
...
const Icon = forwardRef<HTMLElement, IconProps>((props, ref) => {
    ...
    return (
        <i className={cn(`line-clamp-[1em] flex size-[24px]`, className)} {...rest} ref={ref}>
            <svg preserveAspectRatio="none" viewBox={`0 0 ${viewBox} ${viewBox}`}>
