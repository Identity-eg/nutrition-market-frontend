...
export default function ProductPage() {
  return (
    <div className="grid grid-cols-2">
      <div className="flex items-center justify-center border-r border-gray-2 p-[32px]">
        <div>
          {/* <Image width={220} alt="Product image" src={vitaminD3Image} /> */}
        </div>
      </div>
      <div className="p-[32px]">
        <div className="mb-8 border-b border-gray-2 pb-[12px]">
          <h2 className="mb-[4px] typography-SB24">Vitapolygon - omega 3</h2>
          <div className="mb-[24px] flex items-center gap-[8px] text-gray-6 typography-R14">
            <span>1 reviews</span>
